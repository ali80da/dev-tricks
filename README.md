...
# 📱 راهنمای اتصال گوشی اندروید با USB و اجرای برنامه‌ی MAUI Blazor Hybrid

## 1️⃣ فعال‌سازی گزینه‌های توسعه‌دهنده (Developer Options) در گوشی

# Settings > About Phone > Build Number
# 7 بار متوالی روی Build Number ضربه بزنید
🔹 پس از این کار، پیام "You are now a developer!" ظاهر می‌شود.
...
# گزینه را روشن کنید
🔹 این کار به کامپیوتر اجازه می‌دهد با گوشی در حالت دیباگ ارتباط برقرار کند.

---

## 3️⃣ نصب درایور USB گوشی در ویندوز

# در صورت نیاز:
# به سایت سازنده گوشی (سامسونگ، شیائومی، هوآوی و...) مراجعه کنید
# درایور OEM USB مربوط به مدل خود را دانلود و نصب کنید
🔹 اگر در Device Manager ویندوز، گوشی با علامت مثلث زرد (!) دیده شد، درایور مشکل دارد.

---

## 4️⃣ اتصال گوشی با کابل USB

- از کابل با قابلیت انتقال داده استفاده کنید (کابل‌های مخصوص شارژ کار نمی‌کنند).
- گوشی را به پورت USB 2.0 (سیاه یا سفید) وصل کنید.
...
## 5️⃣ تنظیم حالت USB روی PTP یا انتقال فایل

# پس از اتصال کابل، از نوار نوتیفیکیشن گوشی:
# حالت USB را به "Transfer files / MTP" یا "PTP" تغییر دهید
🔹 گاهی حالت "Charge only" باعث می‌شود ADB دستگاه را نبیند.

---

## 6️⃣ بررسی شناسایی گوشی با دستور ADB
...
## 7️⃣ اجرای برنامه از ویژوال استودیو

1. پروژه‌ی MAUI Blazor Hybrid را در Visual Studio 2022 باز کنید.
2. از نوار ابزار، دستگاه هدف را به گوشی خود تغییر دهید (نام گوشی در لیست نمایش داده می‌شود).
3. کلید Start (F5) را بزنید تا برنامه روی گوشی Build و Deploy شود.

---

## 8️⃣ عیب‌یابی وقتی ویژوال استودیو گوشی را نمی‌شناسد

### 🚫 مشکل: گوشی در لیست دستگاه‌های VS دیده نمی‌شود

#### راه‌حل ۱ – کابل و پورت USB را عوض کنید
# از کابل اورجینال یا کابل دارای علامت "داده" استفاده کنید
# پورت USB دیگری را امتحان کنید (ترجیحاً 2.0)

#### راه‌حل ۲ – درایور گوشی را به‌روز کنید
...
#### راه‌حل ۳ – سرور ADB را ریست کنید
adb kill-server
adb start-server
adb devices   # بررسی مجدد

#### راه‌حل ۴ – کامپوننت USB Device Connectivity ویژوال استودیو را نصب کنید
# Visual Studio Installer > Modify > Individual components
# عبارت "USB Device Connectivity" را جستجو و نصب کنید

#### راه‌حل ۵ – گزینه‌های پیش‌نمایش را بررسی کنید
# Tools > Options > Environment > Preview Features
# گزینه ".NET Mono Debugger for MAUI apps" را غیرفعال کنید (در صورت وجود)

#### راه‌حل ۶ – گوشی و کامپیوتر را ریستارت کنید
# گوشی را خاموش و روشن کنید
# کامپیوتر را ریبوت کنید
# دوباره مراحل ۱ تا ۴ را انجام دهید

---

## 9️⃣ مثال عملی: دیباگ یک برنامه MAUI Blazor روی گوشی واقعی

# پس از اتصال موفق:
# در Visual Studio روی نام گوشی کلیک کنید
# F5 بزنید
# خروجی در Output پنجره نشان داده می‌شود
# در گوشی برنامه اجرا می‌شود و می‌توانید با Chrome DevTools از طریق chrome://inspect دیباگ کنید

🔹 برای دیباگ وب‌ویو (Blazor) از مرورگر کروم روی کامپیوتر:
chrome://inspect
# دستگاه متصل را انتخاب کنید
# روی "inspect" کنار صفحه برنامه کلیک کنید

---

## 🎯 خلاصه پرکاربردترین دستورات و تنظیمات

| گزینه / دستور | توضیح |
|----------------|--------|
| Developer Options | فعال‌سازی با ۷ بار کلیک روی Build Number |
| USB Debugging | روشن کردن در Developer Options |
| adb devices | نمایش دستگاه‌های متصل |
| adb kill-server / adb start-server | ریست سرور ADB |
| حالت USB MTP یا PTP | تنظیم در نوتیفیکیشن گوشی |
| USB Device Connectivity | کامپوننت مورد نیاز ویژوال استودیو |
| کابل داده | حتماً از کابل با قابلیت انتقال داده استفاده کنید |

---

## 📚 نکات تکمیلی

- اگر چندین نمونه ویژوال استودیو باز دارید، همه را ببندید و فقط یک نمونه را اجرا کنید.
- از پروکسی یا VPN در هنگام اتصال استفاده نکنید.
- در لینوکس یا مک نیازی به درایور جداگانه نیست، اما ممکن است نیاز به تنظیم udev rules داشته باشید.
- برای اجرا روی گوشی بدون نیاز به کابل USB می‌توانید از Wi‑Fi ADB استفاده کنید (پس از اتصال اولیه با USB دستور adb tcpip 5555 را بزنید).

---

اگر پس از طی این مراحل همچنان مشکل دارید، خروجی دستور adb devices و وضعیت Device Manager را بررسی کنید تا راهنمایی دقیق‌تری ارائه شود.
